...
db_host = "travelapplication.postgres.database.azure.com"
db_database = "travel-planning"
db_user = "travelapplication"
db_password = "Skillbridge123"
...
def payment_success():
    if 'user' in session:
        ...
        for item in cart_items:
            ...
            send_email('your gmail', user_email, 'your password', subject, message_matter)
